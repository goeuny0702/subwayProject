...
info_window = tk.Tk()
info_window.title("부산역")
info_window.geometry("1000x800+450+100")  # 위치 조정
...
# 캔버스 위에 텍스트 추가
can.create_text(500, 300, text="🍞 베이크백", font=bm_font, fill="black")
can.create_text(500, 330, text="운영시간: 10:00 - 18:00", font=bm_font, fill="black")
can.create_text(500, 360, text="주소: 부산 동구 초량중로 53 1층, 2층", font=bm_font, fill="black")
