...
# 캔버스 위에 텍스트 추가
can.create_text(500, 280, text="🍞 베이크백", font=bm_font, fill="black")
can.create_text(500, 300, text="운영시간: 10:00 - 18:00", font=bm_font, fill="black")
can.create_text(500, 320, text="주소: 부산 동구 초량중로 53 1층, 2층", font=bm_font, fill="black")
