...
# 캔버스 위에 텍스트 추가
can.create_text(500, 280, text="🍞 위파티", font=bm_font, fill="black")
can.create_text(500, 300, text="운영시간: 09:00 - 22:00", font=bm_font, fill="black")
can.create_text(500, 320, text="주소: 부산 부산진구 냉정로 166-1", font=bm_font, fill="black")
