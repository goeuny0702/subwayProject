...
# 캔버스 위에 텍스트 추가
can.create_text(500, 300, text="🍞 빠리쟝베이커리", font=bm_font, fill="black")
can.create_text(500, 330, text="운영시간: 08:00 - 21:30", font=bm_font, fill="black")
can.create_text(500, 360, text="주소: 부산 동래구 충렬대로237번길 74", font=bm_font, fill="black")
