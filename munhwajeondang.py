...
# 캔버스 위에 텍스트 추가
can.create_text(500, 280, text="🍞 소맥베이커리", font=bm_font, fill="black")
can.create_text(500, 300, text="운영시간: 10:30 - 20:00", font=bm_font, fill="black")
can.create_text(500, 320, text="주소: 부산 해운대구 센텀남대로 35 지하1층", font=bm_font, fill="black")
