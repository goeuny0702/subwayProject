...
# 캔버스 위에 텍스트 추가
can.create_text(500, 300, text="🍞 소담과자점", font=bm_font, fill="black")
can.create_text(500, 330, text="운영시간: 11:00 - 19:00", font=bm_font, fill="black")
can.create_text(500, 360, text="주소: 경남 김해시 봉황대안길 36", font=bm_font, fill="black")
