...
# 캔버스 위에 텍스트 추가
can.create_text(500, 300, text="🍞 밀곳", font=bm_font, fill="black")
can.create_text(500, 320, text="운영시간: 10:00 - 21:00", font=bm_font, fill="black")
can.create_text(500, 340, text="주소: 부산 중구 부평1길 49 1층", font=bm_font, fill="black")
