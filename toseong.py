...
# 캔버스 위에 텍스트 추가
can.create_text(500, 300, text="🍞 언더베이크", font=bm_font, fill="black")
can.create_text(500, 330, text="운영시간: 11:00 - 22:00", font=bm_font, fill="black")
can.create_text(500, 360, text="주소: 부산 서구 구덕로 168 1층 언더베이크", font=bm_font, fill="black")
