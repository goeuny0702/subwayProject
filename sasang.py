...
# 캔버스 위에 텍스트 추가
can.create_text(500, 300, text="🍞 몽벨쉘터", font=bm_font, fill="black")
can.create_text(500, 330, text="운영시간: 09:00 - 23:00", font=bm_font, fill="black")
can.create_text(500, 360, text="주소: 부산 사상구 사상로224번길 3 1층", font=bm_font, fill="black")
