...
# 캔버스 위에 텍스트 추가
can.create_text(500, 300, text="🍞 럭키베이커리", font=bm_font, fill="black")
can.create_text(500, 330, text="운영시간: 10:30 - 16:00", font=bm_font, fill="black")
can.create_text(500, 360, text="주소: 부산 수영구 무학로49번길 71", font=bm_font, fill="black")

can.create_text(500, 410, text="🍞 페팽과자점", font=bm_font, fill="black")
can.create_text(500, 440, text="운영시간: 08:30 - 21:30", font=bm_font, fill="black")
can.create_text(500, 470, text="주소: 부산 수영구 광서로 1", font=bm_font, fill="black")
