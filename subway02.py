...
#배경 이미지 지정
img1 = Image.open("image/bread.png")
...
bread1 = Image.open("image/bread_icon.png")
bread1 = bread1.resize((60, 60))
breadimg1 = ImageTk.PhotoImage(bread1)

bread2 = Image.open("image/bread2_icon.png")
bread2 = bread2.resize((30, 30))
breadimg2 = ImageTk.PhotoImage(bread2)

bread3 = Image.open("image/bread3_icon.png")
bread3 = bread3.resize((60, 60))
breadimg3 = ImageTk.PhotoImage(bread3)

bread4 = Image.open("image/bread4_icon.png")
bread4 = bread4.resize((60, 60))
breadimg4 = ImageTk.PhotoImage(bread4)

bread5 = Image.open("image/bread5_icon.png")
bread5 = bread5.resize((60, 60))
breadimg5 = ImageTk.PhotoImage(bread5)

bread6 = Image.open("image/bread6_icon.png")
bread6 = bread6.resize((60, 60))
breadimg6 = ImageTk.PhotoImage(bread6)
#endregion 이미지
...
화명_수정 = line(can, 413, 324, 413, 364, "green")
    ...
    for circle in circles:
        ...
        if dx**2 + dy**2 <= (circle["r"]+10)**2:
            ...
            if name == "main":
                ...
                subprocess.Popen(["python", "gaegeum.py"])
            elif name == "광안":
                subprocess.Popen(["python", "gwang-an.py"])
                print("광안 클릭됨")
            elif name == "금련산":
                subprocess.Popen(["python", "geumlyeonsan.py"])
                print("금련산 클릭됨")
            elif name == "센텀시티":
                subprocess.Popen(["python", "gaegeum.py"])
                print("센텀시티 클릭됨")
            elif name == "명륜":
                subprocess.Popen(["python", "myeonglyun.py"])
                print("명륜 클릭됨")
            elif name == "물만골":
                subprocess.Popen(["python", "mulmangol.py"])
                print("물만골 클릭됨")
            elif name == "부산":
                subprocess.Popen(["python", "busan.py"])
                print("부산 클릭됨")
            elif name == "부산대":
                subprocess.Popen(["python", "busandae.py"])
                print("부산대 클릭됨")
            elif name == "사상":
                subprocess.Popen(["python", "sasang.py"])
                print("사상 클릭됨")
            elif name == "서면":
                subprocess.Popen(["python", "seomyeon.py"])
                print("서면 클릭됨")
            elif name == "수영":
                subprocess.Popen(["python", "suyeong.py"])
                print("수영 클릭됨") 
            elif name == "온천장":
                subprocess.Popen(["python", "oncheonjang.py"])
                print("온천장 클릭됨")
            elif name == "전포":
                subprocess.Popen(["python", "jeonpo.py"])
                print("전포 클릭됨")
            elif name == "중동":
                subprocess.Popen(["python", "jungdong.py"])
                print("중동 클릭됨")
            elif name == "중앙":
                subprocess.Popen(["python", "jung-ang.py"])
                print("중앙 클릭됨")
            elif name == "장전":
                subprocess.Popen(["python", "jangjeon.py"])
                print("장전 클릭됨")
            elif name == "자갈치":
                subprocess.Popen(["python", "jagalchi.py"])
                print("자갈치 클릭됨")
            elif name == "초량":
                subprocess.Popen(["python", "choryang.py"])
                print("초량 클릭됨")
            elif name == "해운대":
                subprocess.Popen(["python", "haeundae.py"])
                print("해운대 클릭됨")
            elif name == "연지공원":
                subprocess.Popen(["python", "yeonji.py"])
                print("연지공원 클릭됨")
            elif name == "봉황":
                subprocess.Popen(["python", "bonghwang.py"])
                print("봉황 클릭됨")
            elif name == "부원":
                subprocess.Popen(["python", "buwon.py"])
                print("부원 클릭됨")
            elif name == "구포":
                subprocess.Popen(["python", "gupo.py"])
                print("구포 클릭됨")
            elif name == "수정":
                subprocess.Popen(["python", "sujeong.py"])
                print("수정 클릭됨")
            elif name == "공항":
                subprocess.Popen(["python", "gonghang.py"])
                print("공항 클릭됨")
            elif name == "낫개":
                subprocess.Popen(["python", "natgae.py"])
                print("낫개 클릭됨")
            elif name == "다대포항":
                subprocess.Popen(["python", "dadepohang.py"])
                print("다대포항 클릭됨")
            elif name == "동래":
                subprocess.Popen(["python", "donglae.py"])
                print("동래 클릭됨")
            elif name == "동백":
                subprocess.Popen(["python", "dongbaeg.py"])
                print("동백 클릭됨")
            elif name == "두실":
                subprocess.Popen(["python", "dusil.py"])
                print("두실 클릭됨")
            elif name == "수안":
                subprocess.Popen(["python", "suan.py"])
                print("수안 클릭됨")
            elif name == "전포":
                subprocess.Popen(["python", "jeonpo.py"])
                print("전포 클릭됨")
            elif name == "재송":
                subprocess.Popen(["python", "jaesong.py"])
                print("재송 클릭됨")
            elif name == "토성":
                subprocess.Popen(["python", "toseong.py"])
                print("토성 클릭됨")
            elif name == "화명":
                subprocess.Popen(["python", "hwamyeong.py"])
                print("화명 클릭됨")
            break
...
#빵 이미지 추가
breads=[
    can.create_image(540, 756, image=breadimg2, anchor="center"),
    can.create_image(1118, 700, image=breadimg3, anchor="center"),
    can.create_image(1118, 800, image=breadimg4, anchor="center"),
    can.create_image(1147, 518, image=breadimg5, anchor="center"),
    can.create_image(807, 357, image=breadimg6, anchor="center"),
    can.create_image(880, 580, image=breadimg1, anchor="center"),
    can.create_image(490, 816, image=breadimg2, anchor="center"),
    can.create_image(807, 267, image=breadimg3, anchor="center"),
    can.create_image(413, 637, image=breadimg4, anchor="center"),
    can.create_image(805, 754, image=breadimg5, anchor="center"),
    can.create_image(1118, 650, image=breadimg6, anchor="center"),
    can.create_image(807, 310, image=breadimg1, anchor="center"),
    can.create_image(890, 754, image=breadimg2, anchor="center"),
    can.create_image(1277, 730, image=breadimg3, anchor="center"),
    can.create_image(434, 816, image=breadimg4, anchor="center"),
    can.create_image(807, 227, image=breadimg5, anchor="center"),
    can.create_image(320, 816, image=breadimg6, anchor="center"),
    can.create_image(555, 816, image=breadimg1, anchor="center"),
    can.create_image(1277, 660, image=breadimg2, anchor="center"),
    can.create_image(410, 153, image=breadimg3, anchor="center"),
    can.create_image(280, 105, image=breadimg4, anchor="center"),
    can.create_image(235, 105, image=breadimg5, anchor="center"),
    can.create_image(350, 404, image=breadimg6, anchor="center"),
    can.create_image(413, 364, image=breadimg1, anchor="center"),
    can.create_image(175, 592, image=breadimg2, anchor="center"),
    can.create_image(690, 937, image=breadimg3, anchor="center"),
    can.create_image(750, 937, image=breadimg4, anchor="center"),
    can.create_image(807, 403, image=breadimg5, anchor="center"),
    can.create_image(1277, 570, image=breadimg6, anchor="center"),
    can.create_image(807, 143, image=breadimg1, anchor="center"),
    can.create_image(870, 403, image=breadimg2, anchor="center"),
    can.create_image(890, 754, image=breadimg3, anchor="center"),
    can.create_image(1085, 518, image=breadimg4, anchor="center"),
    can.create_image(264, 816, image=breadimg5, anchor="center"),
    can.create_image(413, 324, image=breadimg6, anchor="center")
]
