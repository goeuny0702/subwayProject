...
# 캔버스 위에 텍스트 추가
can.create_text(500, 300, text="🍞 아델라7", font=bm_font, fill="black")
can.create_text(500, 330, text="운영시간: 06:00 - 21:00", font=bm_font, fill="black")
can.create_text(500, 360, text="주소: 부산 강서구 공항진입로 108 국제선 1층", font=bm_font, fill="black")
