...
# 캔버스 위에 텍스트 추가
can.create_text(500, 300, text="🍞 페를리", font=bm_font, fill="black")
can.create_text(500, 330, text="운영시간: 10:00 - 21:40", font=bm_font, fill="black")
can.create_text(500, 360, text="주소: 부산 사하구 다대로381번길 8 1층", font=bm_font, fill="black")
