...
# 캔버스 위에 텍스트 추가
can.create_text(500, 300, text="🍞 김정욱쌀빵", font=bm_font, fill="black")
can.create_text(500, 330, text="운영시간: 09:00 - 22:00", font=bm_font, fill="black")
can.create_text(500, 360, text="주소: 부산 해운대구 마린시티3로 46 상가동 116호", font=bm_font, fill="black")
