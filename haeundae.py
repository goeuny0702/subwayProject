...
# 캔버스 위에 텍스트 추가
can.create_text(500, 300, text="🍞 조선델리", font=bm_font, fill="black")
can.create_text(500, 330, text="운영시간: 08:00 - 21:30", font=bm_font, fill="black")
can.create_text(500, 360, text="주소: 부산 해운대구 해운대해변로 292 2층", font=bm_font, fill="black")
