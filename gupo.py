...
# 캔버스 위에 텍스트 추가
can.create_text(500, 300, text="🍞 제과점빵", font=bm_font, fill="black")
can.create_text(500, 330, text="운영시간: 08:00 - 19:30", font=bm_font, fill="black")
can.create_text(500, 360, text="주소: 부산 북구 구포만세길 116 1층 제과점빵", font=bm_font, fill="black")
