...
# 캔버스 위에 텍스트 추가
can.create_text(500, 300, text="🍞 금정사계", font=bm_font, fill="black")
can.create_text(500, 330, text="운영시간: 08:30 - 21:00", font=bm_font, fill="black")
can.create_text(500, 360, text="주소: 부산 금정구 금샘로 379", font=bm_font, fill="black")
