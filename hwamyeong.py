...
# 캔버스 위에 텍스트 추가
can.create_text(500, 300, text="🍞 플레인베이커리", font=bm_font, fill="black")
can.create_text(500, 330, text="운영시간: 10:00 - 22:00", font=bm_font, fill="black")
can.create_text(500, 360, text="주소: 부산 북구 금곡대로303번길 36 스페이스303 1층 106호", font=bm_font, fill="black")
