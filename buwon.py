...
# 캔버스 위에 텍스트 추가
can.create_text(500, 300, text="🍞 얼론투게더", font=bm_font, fill="black")
can.create_text(500, 330, text="운영시간: 08:00 - 17:00", font=bm_font, fill="black")
can.create_text(500, 360, text="주소: 경남 김해시 호계로422번길 36 1층", font=bm_font, fill="black")
