...
# 캔버스 위에 텍스트 추가
can.create_text(500, 300, text="🍞 키키베이커리", font=bm_font, fill="black")
can.create_text(500, 330, text="운영시간: 10:00 - 20:30", font=bm_font, fill="black")
can.create_text(500, 360, text="주소: 부산 북구 금곡대로 191 1층 키키베이커리", font=bm_font, fill="black")
