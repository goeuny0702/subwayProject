...
# 캔버스 위에 텍스트 추가
can.create_text(500, 300, text="🍞 아덴블랑제리", font=bm_font, fill="black")
can.create_text(500, 330, text="운영시간: 08:00 - 20:00", font=bm_font, fill="black")
can.create_text(500, 360, text="주소: 경남 김해시 구산로 19 1층", font=bm_font, fill="black")
