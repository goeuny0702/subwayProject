...
# 캔버스 위에 텍스트 추가
can.create_text(500, 300, text="🍞 아치베이커리", font=bm_font, fill="black")
can.create_text(500, 330, text="운영시간: 12:30 - 19:00", font=bm_font, fill="black")
can.create_text(500, 360, text="주소: 부산 중구 중구로44번길 19-1 1층", font=bm_font, fill="black")

can.create_text(500, 410, text="🍞 베티빌리지지", font=bm_font, fill="black")
can.create_text(500, 440, text="운영시간: 11:30 - 19:00", font=bm_font, fill="black")
can.create_text(500, 470, text="주소: 부산 중구 광복중앙로34번길 9 1층", font=bm_font, fill="black")
